...
export default function Nav(){
    ...
    return (
        <nav 
            className="bg-neutral-200 border border-gray-200 dark:border-black rounded-full dark:bg-gray-900 px-3 py-1">
            <div 
                ...
                <a 
                    ...
                    <img 
                        ...
                        alt="Flowbite Logo" 
                    />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">José Flores</span>
                </a>
                <button    
